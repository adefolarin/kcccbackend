          ...
          <div class="col-10">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="text-center">Make Donations</h4>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                ...
                <form method="post" action="{{ url('donation-paypal') }}" enctype="multipart/form-data">@csrf
                    <div class="card-body">
                    <div class="form-group">
                        <label for="donations_name">Name</label>
                        <input type="text" class="form-control"  name="donations_name" id="donations_name" required>
                    </div>
                    <div class="form-group">
                        <label for="donations_email">Email</label>
                        <input type="text" class="form-control"  name="donations_email" id="donations_email" required>
                    </div>
                    <div class="form-group" style="display: none;">
                        <label for="donations_pnum">Phone Number</label>
                        <input type="text" class="form-control"  name="donations_pnum" id="donations_pnum" required
                         value="NA">
                    </div> 
                    <div class="form-group">
                        <label for="donations_amount">Amount($)</label>
                        <input type="text" class="form-control"  name="donations_amount" id="donations_amount" required>
                    </div> 
                    <div class="form-group">
                      <label for="donationcategories_name">Dontion Type</label>
                      <select  class="form-control select2" id="doantions_type" name="donations_type" required style="width: 100%;" required>
                      <option value="">Select Donation Type</option>
                      @foreach($givingcategories as $givingcategory)                
                          <option value="{{ $givingcategory['givingcategories_name'] }}">
                            {{ $givingcategory['givingcategories_name'] }}
                          </option>
                      @endforeach
                      </select>
                    </div>                 
